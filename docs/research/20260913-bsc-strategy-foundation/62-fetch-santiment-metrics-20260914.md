...
We have a number of API methods related to blockchain addresses. The list of supported blockchains [can be found here](/sanapi/supported-blockchains/). Some of these methods return [timeseries](/sanapi/fetching-metrics/#timeseriesdatajson) and others return tables, e.g., “Top Transfers Table”.
